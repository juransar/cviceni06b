<?php
// source: C:\xampp\htdocs\cviceni06b\app/config/config.neon 
// source: C:\xampp\htdocs\cviceni06b\app/config/config.local.neon 

class Container_cd47e19e3c extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\BaseModel' => [
				1 => [
					'24_App_Model_CompanyModel',
					'25_App_Model_EmployerModel',
					'26_App_Model_PidModel',
					'27_App_Model_StatisticModel',
					'umodel',
				],
			],
			'Nette\Object' => [
			...
			'App\Model\CompanyModel' => [1 => ['24_App_Model_CompanyModel']],
			'App\Model\EmployerModel' => [1 => ['25_App_Model_EmployerModel']],
			'App\Model\PidModel' => [1 => ['26_App_Model_PidModel']],
			'App\Model\StatisticModel' => [1 => ['27_App_Model_StatisticModel']],
			'App\Forms\CompanyFormFactory' => [1 => ['companyservice']],
			'App\Forms\EmployerFormFactory' => [1 => ['employerservice']],
			'App\Forms\PidFormFactory' => [1 => ['pidservice']],
			'App\Model\UtilityModel' => [1 => ['umodel']],
		...
		'services' => [
			'24_App_Model_CompanyModel' => 'App\Model\CompanyModel',
			'25_App_Model_EmployerModel' => 'App\Model\EmployerModel',
			'26_App_Model_PidModel' => 'App\Model\PidModel',
			'27_App_Model_StatisticModel' => 'App\Model\StatisticModel',
			...
			'companyservice' => 'App\Forms\CompanyFormFactory',
			'container' => 'Nette\DI\Container',
			'database.default.connection' => 'Nette\Database\Connection',
			'database.default.context' => 'Nette\Database\Context',
			'database.default.conventions' => 'Nette\Database\Conventions\DiscoveredConventions',
			'database.default.structure' => 'Nette\Database\Structure',
			'employerservice' => 'App\Forms\EmployerFormFactory',
			...
			'pidservice' => 'App\Forms\PidFormFactory',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\cviceni06b\app',
			'wwwDir' => 'C:\xampp\htdocs\cviceni06b\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\xampp\htdocs\cviceni06b\app/../temp',
		];
	}
	 ...
	 */
	public function createService__24_App_Model_CompanyModel()
	{
	 ...
	 */
	public function createService__25_App_Model_EmployerModel()
	{
	 ...
	 */
	public function createService__26_App_Model_PidModel()
	{
	 ...
	 */
	public function createService__27_App_Model_StatisticModel()
	{
		$service = new App\Model\StatisticModel($this->getService('24_App_Model_CompanyModel'),
			$this->getService('25_App_Model_EmployerModel'));
		return $service;
	}
	...
	public function createServiceApplication__1()
	{
		...
		$service->injectDependencies($this->getService('companyservice'), $this->getService('24_App_Model_CompanyModel'),
			$this->getService('umodel'));
	...
	public function createServiceApplication__2()
	{
		...
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			...
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->injectDependencies($this->getService('employerservice'), $this->getService('25_App_Model_EmployerModel'),
			$this->getService('24_App_Model_CompanyModel'), $this->getService('umodel'),
			$this->getService('26_App_Model_PidModel'));
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	public function createServiceApplication__6()
	{
		...
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			...
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->injectDependencies($this->getService('pidservice'), $this->getService('26_App_Model_PidModel'),
			$this->getService('umodel'));
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	public function createServiceApplication__7()
	{
		...
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			...
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->injectDependencies($this->getService('27_App_Model_StatisticModel'));
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\cviceni06b\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\cviceni06b\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\cviceni06b\app/../temp/cache',
	 ...
	 */
	public function createServiceCompanyservice()
	{
		$service = new App\Forms\CompanyFormFactory;
		$service->injectDependencies($this->getService('24_App_Model_CompanyModel'));
		return $service;
	}
	 ...
	 */
	public function createServiceEmployerservice()
	{
		$service = new App\Forms\EmployerFormFactory;
		$service->injectDependencies($this->getService('25_App_Model_EmployerModel'));
		return $service;
	}
	...
	{
		return new Container_cd47e19e3c_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	 ...
	 */
	public function createServicePidservice()
	{
		$service = new App\Forms\PidFormFactory;
		$service->injectDependencies($this->getService('26_App_Model_PidModel'));
		return $service;
	}
	 ...
	 */
	public function createServiceUmodel()
	{
		$service = new App\Model\UtilityModel($this->getService('26_App_Model_PidModel'));
		return $service;
	}
	...
	public function initialize()
	{
		...
		Vojtys\Forms\Typeahead\TypeaheadExtension::bind([]);
	}
...
class Container_cd47e19e3c_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_cd47e19e3c $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\xampp\htdocs\cviceni06b\app/../temp/cache/latte');
